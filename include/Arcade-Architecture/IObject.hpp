...
namespace arcade {
     ...
     * 
     */
    enum Input {UNDEFINED = -1,LEFT, RIGHT, UP, DOWN, ACTION1, NEXTGRAPH, NEXTGAME, PREVIOUSGRAPH, PREVIOUSGAME, RESTART, MENU, EXIT};
    ...
    /**
     * @brief Enumerate the possible sound states in the arcarde box
     * 
     */
    enum MusicState {PAUSE, PLAY};
    ...
    class ITile : public IObject {
        public:
             ...
             * @return std::pair<float, float>
             */
            virtual std::pair<std::size_t, std::size_t> getScale() const = 0;
